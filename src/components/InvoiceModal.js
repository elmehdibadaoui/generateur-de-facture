...
class InvoiceModal extends React.Component {
  ...
  GenerateInvoice = (event) => {
    // var entrepriseLogo = this.props.info.entrepriseLogo;
    // html2canvas(document.querySelector("#invoiceCapture")).then((canvas) => {
    //   const imgData = canvas.toDataURL('image/png', 1.0);
    //   // entrepriseLogo = imgData;
    //   console.log(imgData);
    //   const pdf = new jsPDF({
    ...
    //   console.log(entrepriseLogo);
    //   pdf.addImage(entrepriseLogo, 'PNG', 20, 20, 120, 120); //base64 image, format, x-coordinate, y-coordinate, width, height
    ...
    doc.html(document.querySelector("#invoiceCapture"), {
        async callback(doc) {
            await doc.save('facture-001.pdf');
        },
    });
    ...
    return(
      <div>
        <Modal show={this.props.showModal} onHide={this.props.closeModal} size="lg" centered>
          ...
          {/* <div className="d-none" id="invoiceCapture">
